...
export default async function ProductPage({ params }) {
  ...
  return (
    <div className="shop-page">
      ...
      <div id="reviews" style={{ marginTop: "3rem", maxWidth: "900px" }}>
        <h2 className="shop-title" style={{ fontSize: "1.4rem", marginBottom: "0" }}>Customer Reviews</h2>
      ...
      {relatedProducts.length > 0 && (
        <div style={{ marginTop: "3rem" }}>
          <h2 className="shop-title" style={{ fontSize: "1.4rem", marginBottom: "0" }}>You May Also Like</h2>
